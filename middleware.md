---
description: >-
  Middleware es una función encadenada en ciclo de una solicitud HTTP con acceso
  al Context que utiliza para realizar una acción especifica, por ejemplo,
  registrar cada solicitud o habilitar CORS.
---
